                    ...
                    <div class="row mt-3">
                        @foreach ($informasi as $x)
                            <div class="col-md-6 col-lg-4 col-xxl-3 my-3">
                                <div class="card bg-white" style="min-height:35rem">
                                    <div class="card-body row">
                                        <div class="col-12 d-flex justify-content-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="6rem" height="10rem"
                                        ...
                                        <div class="col-12">
                                            <p class="fs-25">
                                                <a href="javascript:void(0)" data-bs-toggle="modal"
                                                    ...
                                                    class="breadcrumb-item link-secondary  text-decoration-none"><b>
                                                        {{ $x->nama_file }} </b></a>
                                            </p>
                                            <p class="text-truncate">{{ $x->tipe }}</p>
                                            <p class="text-truncate">Dibuat : {{ $x->created_at }}</p>
                                            <p class="text-truncate">Diperbaharui : {{ $x->updated_at }}</p>
                                ...
                                <div class="modal-dialog modal-xl">
                                    <div class="modal-content bg-white">
                                        <div class="modal-header" data-bs-theme="white">
                                            <h1 class="modal-title fs-5" id="exampleModalLabel">Lihat Dokumen
                                                {{ $x->nama_file }}</h1>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                            <embed width="100%" height="650" src="{{ asset($x->file) }}"
