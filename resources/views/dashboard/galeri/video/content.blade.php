        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="forms-sample" action="{{ route('video.simpan') }}" method="post"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="form-group row">
                            <label for="judul" class="col-sm-3 col-form-label">ID Youtube</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="youtube" id="id_youtube_tambah"
                            ...
                            <tbody>
                                @foreach ($video as $x)
                                    <tr>
                                        ...
                                        <td> {{ $x->youtube }}</td>
                                        <td> <a class="video-spotlight"
                                                href="https://www.youtube.com/embed/{{ $x->youtube }}">
                                    ...
                                    <div class="modal fade" id="edit_{{ $x->id }}" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form class="forms-sample" action="{{ route('video.update', $x->id) }}"
                                                        method="POST" enctype="multipart/form-data">
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="form-group row">
                                                            <label for="judul" class="col-sm-3 col-form-label">ID
                                                                Youtube</label>
                                                            <div class="col-sm-9">
                                                                <input type="text" class="form-control" name="youtube"
                                                                    id="id_youtube_edit" value="{{ $x->youtube }}"
                                                                    placeholder="ID Youtube">
                                                            </div>
                                                        </div>
                                                        <p class="font-weight-bold">ID youtube didapatkan dari link url
                                                            yang di tuju</p>
                                                        <p class="font-weight-bold ">contoh link
                                                            https://www.youtube.com/watch?v=b2KXsyoaBF4 </p>
                                                        <p class="font-weight-bold mb-3">11 kombinasi huruf dan angka
                                                            setelah v= adalah id dari video
                                                            (b2KXsyoaBF4)
                                                        </p>
                                                        <button type="submit"
