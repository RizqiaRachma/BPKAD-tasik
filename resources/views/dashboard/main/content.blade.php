@section('main')
    <div class="content-wrapper">
        ...
        <div class="row">
            ...
            <div class="col-12 grid-margin transparent row">
                    ...
                    <div class="col-md-6 mb-4 mb-lg-0 stretch-card transparent">
                        <div class="card card-light-blue">
                            <div class="card-body">
                                ...
                                <p class="fs-30 mb-2">{{ $jumlahRegulasi }} Dokumen Regulasi</p>
                                {{-- <p>2.00% (30 days)</p> --}}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 stretch-card transparent">
                        <div class="card card-tale">
                            <div class="card-body">
                                ...
                                <p class="fs-30 mb-2">{{ $jumlahInformasi }} Dokumen Informasi</p>
                                {{-- <p>0.22% (30 days)</p> --}}
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12 row ">
                    <div class="col-md-6 mb-4 stretch-card transparent">
                        <div class="card card-tale">
                            <div class="card-body">
                                ...
                                <p class="fs-30 mb-2">{{ $jumlahFoto }} Foto</p>
                                {{-- <p>10.00% (30 days)</p> --}}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 mb-4 stretch-card transparent">
                        <div class="card card-dark-blue">
                            <div class="card-body">
                                ...
                                <p class="fs-30 mb-2">{{ $jumlahVideo }} Video</p>
                                {{-- <p>22.00% (30 days)</p> --}}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 mb-4 stretch-card transparent">
                        <div class="card card-dark-blue">
                            <div class="card-body">
                                ...
                                <p class="fs-30 mb-2">{{ $jumlahPesan }} Pesan</p>
                                {{-- <p>22.00% (30 days)</p> --}}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 mb-4 stretch-card transparent">
                        <div class="card card-light-danger">
                            <div class="card-body">
                                <p class="mb-4">
                                    Total Pesan Belum di Respons
                                </p>
                                <p class="fs-30 mb-2">{{ $jumlahPesanMenunggu }} Pesan</p>
                                {{-- <p>22.00% (30 days)</p> --}}
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <canvas id="order-chart" style="display: block; height: 321px; width: 643px;" width="964"
                            height="481" class="chartjs-render-monitor"></canvas>
                    </div>
                </div>
            </div>
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <canvas id="sales-chart" style="display: block; height: 321px; width: 643px;" width="964"
                            height="481" class="chartjs-render-monitor"></canvas>
                    </div>
                </div>
            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mt-3">
                                                    ...
                                                    <canvas id="north-america-chart"
                                                        style="display: block; height: 245px; width: 490px;"
                                                        width="735" height="367"
